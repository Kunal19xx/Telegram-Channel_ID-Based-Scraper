...
Currently some Telegram channels use special characters in channel name or sometimes keep the name hidden making scraping impossible by usual method. This tool uses the channel ID to fetch information from the channeles such as messages, posts etc.
